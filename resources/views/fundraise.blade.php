                ...
                <div class="bg-white border rounded-0 shadow">
                    <form action="{{ route('sendCreateFundraiseForm')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="shadow-sm form-row">
                            ...
                            <div class="form-group col-md-6"><input class="form-control" type="email" name="email" id="email" placeholder="Email"></div>
                            <div class="form-group col-md-6"><input class="form-control" type="password" name="password" id="password" placeholder="Password"></div>
                            ...
                            <div class="form-group col-md-6"><input class="form-control" type="date" name="start_date" id="start_date" placeholder="Start Date" required=""></div>
                            <div class="form-group col-md-6"><input class="form-control" type="date" name="end_date" id="end_date" placeholder="End Date" required=""></div>
