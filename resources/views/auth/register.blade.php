                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="address1" class="form-control" rows="4" cols="60" name="address1" value="" required autocomplete="address1" autofocus></textarea>
                                @error('address1')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="address2" class="form-control" rows="4" cols="60" name="address2" value="" autocomplete="address2" autofocus></textarea>
                                @error('address2')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select class="form-control @error('city') is-invalid @enderror" name="city" id="city" required autocomplete="city" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select class="form-control @error('user_type') is-invalid @enderror" name="user_type" id="user_type" required autocomplete="user_type" autofocus>
                                    <option value="">Please Select</option> 
