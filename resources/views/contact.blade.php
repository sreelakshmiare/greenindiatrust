...
<section class="section-about">
        <div>
            <div class="container-fluid">
                ...
                <hr>
                <form class="border rounded-0 border-light shadow-sm" id="contactForm" data-bss-recipient="a341fb96315996c7457de8d5d2b72d5c" data-bss-subject="Green India Trust Contact"><input class="form-control" type="hidden" name="Introduction" value="Intersted in Voluteering"><input class="form-control" type="hidden" name="subject" value="Green India Trust Contact Form"><input class="form-control" type="hidden" name="to"
                        value="chairman@gitrust.org">
                    <div class="form-row">
                        <div class="col-md-6">
                    ...
                    <div class="form-row">
                        <div class="col-12 col-md-6" id="message">
                            <h3 class="text-success h4"><i class="fa fa-envelope"></i> Contact Us<small><small class="required-input">&nbsp;(*required)</small></small>
                            </h3>
                            <div class="form-group"><label class="text-success" for="from-name">Name</label><span class="required-input">*</span>
                            ...
                            <div class="form-group"><label class="text-success" for="from-email">Email</label><span class="required-input">*</span>
                                <div class="input-group">
                            ...
                            <div class="form-row">
                                <div class="col-12 col-sm-6 col-md-12 col-lg-6">
                                    <div class="form-group"><label class="text-success" for="from-phone">Phone</label><span class="required-input">*</span>
                                        <div class="input-group">
                                ...
                                <div class="col-12 col-sm-6 col-md-12 col-lg-6">
                                    <div class="form-group"><label class="text-success" for="from-calltime">Best Time to Call</label>
                                        <div class="input-group">
                            ...
                            <div class="form-group"><label class="text-success" for="from-comments">Comments</label><textarea class="form-control" id="from-comments" name="comments" placeholder="Enter Comments" rows="5"></textarea></div>
                            <div class="form-group">
                                <div class="form-row">
                                    <div class="col"><button class="btn btn-primary btn-block bg-success" type="reset"><i class="fa fa-undo"></i> Reset</button></div>
                                    <div class="col"><button class="btn btn-primary btn-block bg-success" type="submit">Submit <i class="fa fa-chevron-circle-right"></i></button></div>
                                </div>
                            </div>
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <div class="form-row">
                                <div class="col-12">
                                    <div class="static-map"><iframe allowfullscreen="" frameborder="0" src="https://www.google.com/maps/embed/v1/place?key=AIzaSyDCa9v4vrSSf97hHgNyrx5fjH024gKq0jU&amp;q=Lotus+Hospital%2C+Pogathota%2C+Nellore&amp;zoom=15" width="100%" height="400"></iframe></div>
                                </div>
                                <div class="col-sm-6 col-md-12 col-lg-6">
                                    <h2 class="text-success h4"><i class="fa fa-user"></i> Our Info</h2>
                                    <div><span class="text-success"><strong>Name</strong></span></div>
                                    <div><span class="text-success">email@awebsite.com</span></div>
                                    <div><span class="text-success">www.awebsite.com</span></div>
                                    <hr class="d-sm-none d-md-block d-lg-none">
                                </div>
                                <div class="col-sm-6 col-md-12 col-lg-6">
                                    <h2 class="text-success h4"><i class="fa fa-location-arrow"></i> Our Address</h2>
                                    <div><span class="text-success"><strong>Office Name</strong></span></div>
                                    <div><span class="text-success">55 Icannot Dr</span></div>
                                    <div><span class="text-success">Daytone Beach, FL 85150</span></div>
